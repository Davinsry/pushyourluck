  ...
  return (
    <div className="flex min-h-[85vh] flex-col items-center justify-center text-center py-6 pointer-events-none">
      ...
      >
        ...
        <button
          className="tp-btn mt-4 flex items-center justify-center gap-2 rounded-2xl bg-flame px-12 py-4 text-xl font-extrabold text-white shadow-2xl border border-chili/25 hover:scale-105 active:scale-95 transition-all duration-150 w-full"
          onClick={onStart}
        >
